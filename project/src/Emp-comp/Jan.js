...
const Jan = () => {
  ...
  return (
    <div className='adminpage12' ref={conponentPDF} style={{width:'100%'}}>
         <h1>Admin Page</h1>
        <hr/>  
        <div className="btn-1">
        <div className='sort1'>
        ...
        <div className="search1"> 
            <NavLink to="/"><button className='button12'>Back</button></NavLink>               
                <input  type="text" name='name'  onChange={handlesearch} placeholder='Search...' />
                <button  className="btn12" onClick={generatePDF}>PDF</button>       
        </div>
        ...
        <div className="adminpage-content1" >
            <table className='adminpage-table1'>
                <thead >
                    <tr>
			        <th className='heading12' name="employeename">EMPLOYEE NAME </th>
			        <th className='heading12' name="projectname">PROJECT NAME </th>
			        <th className='heading12' name="shifttimings">SHIFT TIMINGS </th>
			        <th className='heading12' name="holidaydate">HOLIDAY DATE </th>
			        <th className='heading12' name="description">DESCRIPTION </th>
			        <th className='heading12' name="managername">MANAGER NAME </th>
                    <th className='heading12' name="workingdays">WORKING DAYS </th>
                    <th className='heading12' name="status">STATUS </th>
                    </tr>
                </thead >
                <tbody>
